...
use Closure;
use Tune\Contracts\Auth\Factory as FactoryContract;
use InvalidArgumentException;

/**
 * @mixin \Tune\Contracts\Auth\Guard
 * @mixin \Tune\Contracts\Auth\StatefulGuard
 */
