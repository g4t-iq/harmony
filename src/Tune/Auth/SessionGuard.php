...
use Tune\Auth\Events\Attempting;
use Tune\Auth\Events\Authenticated;
use Tune\Auth\Events\CurrentDeviceLogout;
use Tune\Auth\Events\Failed;
use Tune\Auth\Events\Login;
use Tune\Auth\Events\Logout;
use Tune\Auth\Events\OtherDeviceLogout;
use Tune\Auth\Events\Validated;
use Tune\Contracts\Auth\Authenticatable as AuthenticatableContract;
use Tune\Contracts\Auth\StatefulGuard;
use Tune\Contracts\Auth\SupportsBasicAuth;
use Tune\Contracts\Auth\UserProvider;
use Tune\Contracts\Cookie\QueueingFactory as CookieJar;
use Tune\Contracts\Events\Dispatcher;
use Tune\Contracts\Session\Session;
use Tune\Support\Arr;
use Tune\Support\Facades\Hash;
use Tune\Support\Str;
use Tune\Support\Timebox;
...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     *
     * @var \Tune\Contracts\Session\Session
     */
    protected $session;

    /**
     * The Tune cookie creator service.
     *
     * @var \Tune\Contracts\Cookie\QueueingFactory
     */
    protected $cookie;
     ...
     * @param  \Tune\Contracts\Session\Session  $session
     * @param  \Symfony\Component\HttpFoundation\Request|null  $request
     * @param  \Tune\Support\Timebox|null  $timebox
     * @return void
     */
     ...
     *
     * @return \Tune\Contracts\Auth\Authenticatable|null
     */
     ...
     *
     * @param  \Tune\Auth\Recaller  $recaller
     * @return mixed
     */
     ...
     *
     * @return \Tune\Auth\Recaller|null
     */
     ...
     *
     * @param  mixed  $id
     * @return \Tune\Contracts\Auth\Authenticatable|false
     */
     ...
     *
     * @param  \Tune\Contracts\Auth\Authenticatable|null  $user
     * @param  array  $credentials
     * @return void
     */
     ...
     *
     * @return \Tune\Contracts\Cookie\QueueingFactory
     *
     ...
     *
     * @param  \Tune\Contracts\Cookie\QueueingFactory  $cookie
     * @return void
     */
     ...
     *
     * @return \Tune\Contracts\Session\Session
     */
