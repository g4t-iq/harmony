...
use Tune\Console\Concerns\CreatesMatchingTest;
use Tune\Contracts\Console\PromptsForMissingInput;
...
abstract class GeneratorCommand extends Command implements PromptsForMissingInput
{
     ...
     * @return bool|null
     *
     * @throws \Tune\Contracts\Filesystem\FileNotFoundException
     */
    ...
    protected function getPath($name)
    {
        ...
        return $this->harmony['path'].'/'.str_replace('\\', '/', $name).'.php';
    }
    ...
    {
        return $this->harmony->getNamespace();
    }
    ...
    {
        $views = $this->harmony['config']['view.paths'][0] ?? resource_path('views');
