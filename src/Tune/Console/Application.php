...
use Closure;
use Tune\Console\Events\ArtisanStarting;
use Tune\Contracts\Console\Application as ApplicationContract;
...
class Application extends SymfonyApplication implements ApplicationContract
{
     ...
     * @return void
     */
    public function __construct(Container $harmony, Dispatcher $events, $version)
    {
        parent::__construct('Harmony Framework', $version);
    ...
    protected function parseCommand($command, $parameters)
    {
        if (is_subclass_of($command, SymfonyCommand::class)) {
            ...
            $command = $this->harmony->make($command)->getName();
        }
    ...
    public function add(SymfonyCommand $command)
    {
        if ($command instanceof Command) {
            $command->setHarmony($this->harmony);
        }
     ...
     *
     * @param  \Tune\Console\Command|string  $command
    ...
    public function resolve($command)
    {
        ...
        return $this->add($this->harmony->make($command));
    }
    ...
    {
        $this->setCommandLoader(new ContainerCommandLoader($this->harmony, $this->commandMap));
