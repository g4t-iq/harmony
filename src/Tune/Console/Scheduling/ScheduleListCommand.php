...
class ScheduleListCommand extends Command
{
     ...
     *
     * @param  \Tune\Support\Collection  $events
     ...
     */
    private function sortEvents(\Tune\Support\Collection $events, DateTimeZone $timezone)
    {
     ...
     *
     * @param  \Tune\Console\Scheduling\CallbackEvent  $event
     * @return string
     */
    private function getClosureLocation(CallbackEvent $event)
    {
        ...
        if ($callback instanceof Closure) {
            ...
            return sprintf(
                '%s:%s',
                str_replace($this->harmony->basePath().DIRECTORY_SEPARATOR, '', $function->getFileName() ?: ''),
