...
class Schedule
{
     ...
     *
     * @var \Tune\Console\Scheduling\EventMutex
     */
     ...
     *
     * @var \Tune\Console\Scheduling\SchedulingMutex
     */
    ...
    public function __construct($timezone = null)
    {
        ...
        if (! class_exists(Container::class)) {
            throw new RuntimeException(
                'A container implementation is required to use the scheduler. Please install the tune/container package.'
            );
        }
     ...
     * @return \Tune\Console\Scheduling\CallbackEvent
     */
     ...
     * @param  array  $parameters
     * @return \Tune\Console\Scheduling\Event
     */
    ...
    protected function dispatchToQueue($job, $queue, $connection)
    {
        if ($job instanceof Closure) {
            if (! class_exists(CallQueuedClosure::class)) {
                throw new RuntimeException(
                    'To enable support for closure jobs, please install the tune/queue package.'
                );
            }
     ...
     *
     * @return \Tune\Contracts\Bus\Dispatcher
     *
     * @throws \RuntimeException
     */
    protected function getDispatcher()
    {
        if ($this->dispatcher === null) {
            try {
                ...
                throw new RuntimeException(
                    'Unable to resolve the dispatcher from the service container. Please bind it or install the tune/bus package.',
