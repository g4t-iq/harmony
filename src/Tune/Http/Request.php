...
use Tune\Session\SymfonySessionDecorator;
...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * Create a new Tune HTTP request from server variables.
     *
     * @return static
     */
    ...
    /**
     * This method belongs to Symfony HttpFoundation and is not usually needed when using Harmony.
     *
    ...
    /**
     * Create a new request instance from the given Harmony request.
     *
     * @param  \Tune\Http\Request  $from
     * @param  \Tune\Http\Request|null  $to
     * @return static
     */
    public static function createFrom(self $from, $to = null)
    {
        ...
        if ($from->hasSession() && $session = $from->session()) {
            $request->setHarmonySession($session);
        }
    ...
    /**
     * Create an Tune request from a Symfony instance.
     *
     ...
     * @return void
     */
    public function setHarmonySession($session)
    {
     ...
     * @param  mixed  $default
     * @return \Tune\Routing\Route|object|string|null
     */
