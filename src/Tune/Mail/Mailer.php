...
use Tune\Contracts\Mail\Mailable as MailableContract;
use Tune\Contracts\Mail\Mailer as MailerContract;
use Tune\Contracts\Mail\MailQueue as MailQueueContract;
use Tune\Contracts\Queue\Factory as QueueContract;
use Tune\Contracts\Queue\ShouldQueue;
use Tune\Contracts\Support\Htmlable;
use Tune\Contracts\View\Factory;
use Tune\Mail\Events\MessageSending;
use Tune\Mail\Events\MessageSent;
use Tune\Mail\Mailables\Address;
...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @var \Tune\Contracts\View\Factory
     */
    protected $views;
     ...
     *
     * @var \Tune\Contracts\Events\Dispatcher|null
     */
    protected $events;
     ...
     *
     * @param  string  $name
     * @param  \Tune\Contracts\View\Factory  $views
     * @param  \Symfony\Component\Mailer\Transport\TransportInterface  $transport
     * @param  \Tune\Contracts\Events\Dispatcher|null  $events
     * @return void
     */
     ...
     *
     * @param  \Tune\Contracts\Mail\Mailable|string|array  $view
     * @param  array  $data
     ...
     *
     * @param  \Tune\Contracts\Mail\Mailable  $mailable
     * @return \Tune\Mail\SentMessage|null
     */
     ...
     *
     * @param  string  $queue
     * @param  \Tune\Contracts\Mail\Mailable  $view
     * @return mixed
     */
     ...
     *
     * @param  \Tune\Mail\SentMessage  $message
     * @param  array  $data
     * @return void
     */
     ...
     *
     * @return \Tune\Contracts\View\Factory
     */
