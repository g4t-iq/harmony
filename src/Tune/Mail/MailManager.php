...
use Closure;
use Tune\Contracts\Mail\Factory as FactoryContract;
use Tune\Log\LogManager;
use Tune\Mail\Transport\ArrayTransport;
use Tune\Mail\Transport\LogTransport;
use Tune\Mail\Transport\SesTransport;
use Tune\Mail\Transport\SesV2Transport;
use Tune\Support\Arr;
use Tune\Support\ConfigurationUrlParser;
...
class MailManager implements FactoryContract
{
     ...
     *
     * @param  array  $config
     * @return \Tune\Mail\Transport\SesTransport
     */
     ...
     *
     * @param  array  $config
     * @return \Tune\Mail\Transport\Se2VwTransport
     */
    ...
    protected function createFailoverTransport(array $config)
    {
        ...
        foreach ($config['mailers'] as $name) {
            ...
            // with any Harmony <= 6.x application style mail configuration files.
     ...
     *
     * @param  array  $config
     * @return \Tune\Mail\Transport\LogTransport
     */
     ...
     *
     * @return \Tune\Mail\Transport\ArrayTransport
     */
    ...
    protected function getConfig(string $name)
    {
        ...
        // provide "BC" for any Harmony <= 6.x style mail configuration files.
    ...
    public function getDefaultDriver()
    {
        ...
        // of the Harmony mail configuration file for backwards compatibility.
