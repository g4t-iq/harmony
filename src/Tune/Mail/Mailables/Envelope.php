...
class Envelope
{
     ...
     *
     * @var \Tune\Mail\Mailables\Address|string|null
     */
    public $from;
     ...
     *
     * @param  \Tune\Mail\Mailables\Address|string|null  $from
     * @param  array  $to
     * @param  array  $cc
     * @param  array  $bcc
     * @param  array  $replyTo
     ...
     *
     * @param  \Tune\Mail\Mailables\Address|string  $address
     ...
     *
     * @param  \Tune\Mail\Mailables\Address|array|string  $address
     * @param  string|null  $name
     * @return $this
     */
