...
abstract class AbstractCursorPaginator implements Htmlable
{
     ...
     * The current cursor.
     *
     * @var \Tune\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param  \Tune\Pagination\Cursor|null  $cursor
     * @return string
     */
     ...
     *
     * @return \Tune\Pagination\Cursor|null
     */
     ...
     *
     * @param  \Tune\Support\Collection  $collection
     * @return $this
     */
