...
use Tune\Queue\Connectors\BeanstalkdConnector;
use Tune\Queue\Connectors\DatabaseConnector;
use Tune\Queue\Connectors\NullConnector;
use Tune\Queue\Connectors\RedisConnector;
use Tune\Queue\Connectors\SqsConnector;
use Tune\Queue\Connectors\SyncConnector;
use Tune\Queue\Failed\DatabaseFailedJobProvider;
use Tune\Queue\Failed\DatabaseUuidFailedJobProvider;
use Tune\Queue\Failed\DynamoDbFailedJobProvider;
use Tune\Queue\Failed\FileFailedJobProvider;
use Tune\Queue\Failed\NullFailedJobProvider;
...
class QueueServiceProvider extends ServiceProvider implements DeferrableProvider
{
     ...
     *
     * @param  \Tune\Queue\QueueManager  $manager
     * @return void
     */
     ...
     *
     * @param  array  $config
     * @return \Tune\Queue\Failed\DatabaseFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \Tune\Queue\Failed\DatabaseUuidFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \Tune\Queue\Failed\DynamoDbFailedJobProvider
     */
