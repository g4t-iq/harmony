...
use Tune\Contracts\Cache\Repository as CacheContract;
use Tune\Contracts\Debug\ExceptionHandler;
use Tune\Contracts\Events\Dispatcher;
use Tune\Contracts\Queue\Factory as QueueManager;
use Tune\Database\DetectsLostConnections;
use Tune\Queue\Events\JobExceptionOccurred;
use Tune\Queue\Events\JobPopped;
use Tune\Queue\Events\JobPopping;
use Tune\Queue\Events\JobProcessed;
use Tune\Queue\Events\JobProcessing;
use Tune\Queue\Events\JobReleasedAfterException;
use Tune\Queue\Events\JobTimedOut;
use Tune\Queue\Events\Looping;
use Tune\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     *
     * @var \Tune\Contracts\Queue\Factory
     */
    protected $manager;
     ...
     *
     * @param  \Tune\Contracts\Queue\Factory  $manager
     * @param  \Tune\Contracts\Events\Dispatcher  $events
     * @param  \Tune\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \Tune\Queue\WorkerOptions  $options
     * @return int
     */
     ...
     *
     * @param  \Tune\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     * @return \Tune\Contracts\Queue\Job|null
     */
    ...
    {
        if ($this->cache) {
            return $this->cache->get('tune:queue:restart');
        }
    }
     ...
     *
     * @param  int  $status
     * @param  \Tune\Queue\WorkerOptions|null  $options
     * @return never
     */
     ...
     *
     * @param  \Tune\Contracts\Queue\Job  $job
     * @return \Tune\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @param  \Tune\Contracts\Queue\Job  $job
     * @return \Tune\Queue\TimeoutExceededException
     */
     ...
     *
     * @return \Tune\Contracts\Queue\Factory
     */
