...
use Tune\Contracts\Queue\ClearableQueue;
use Tune\Contracts\Queue\Queue as QueueContract;
use Tune\Database\Connection;
use Tune\Queue\Jobs\DatabaseJob;
use Tune\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \Tune\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string  $queue
     * @param  \Tune\Queue\Jobs\DatabaseJobRecord  $job
     * @param  int  $delay
     * @return mixed
     */
     ...
     *
     * @param  string|null  $queue
     * @return \Tune\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \Tune\Queue\Jobs\DatabaseJobRecord  $job
     * @return \Tune\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  \Tune\Queue\Jobs\DatabaseJobRecord  $job
     * @return \Tune\Queue\Jobs\DatabaseJobRecord
     */
     ...
     *
     * @param  string  $queue
     * @param  \Tune\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
