...
use Tune\Queue\Listener;
use Tune\Queue\ListenerOptions;
...
class ListenCommand extends Command
{
     ...
     *
     * @param  \Tune\Queue\Listener  $listener
     * @return void
     */
    ...
    {
        $connection = $connection ?: $this->harmony['config']['queue.default'];

        return $this->input->getOption('queue') ?: $this->harmony['config']->get(
     ...
     *
     * @return \Tune\Queue\ListenerOptions
     */
