...
namespace Tune\Queue\Jobs;

use Tune\Container\Container;
use Tune\Contracts\Queue\Job as JobContract;
use Tune\Queue\DatabaseQueue;
...
class DatabaseJob extends Job implements JobContract
{
     ...
     * @param  \Tune\Queue\DatabaseQueue  $database
     * @param  \stdClass  $job
