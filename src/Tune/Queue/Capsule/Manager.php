...
namespace Tune\Queue\Capsule;

use Tune\Container\Container;
use Tune\Queue\QueueManager;
use Tune\Queue\QueueServiceProvider;
use Tune\Support\Traits\CapsuleManagerTrait;

/**
 * @mixin \Tune\Queue\QueueManager
 * @mixin \Tune\Contracts\Queue\Queue
 */
class Manager
{
     ...
     *
     * @return \Tune\Queue\QueueManager
     */
