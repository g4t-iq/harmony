...
use Tune\Contracts\Process\ProcessResult as ProcessResultContract;
...
class FakeProcessSequence
{
     ...
     *
     * @var \Tune\Contracts\Process\ProcessResult|\Tune\Process\FakeProcessDescription
     */
     ...
     *
     * @param  \Tune\Contracts\Process\ProcessResult|\Tune\Process\FakeProcessDescription|array|string  $process
     * @return $this
     */
     ...
     *
     * @param  \Tune\Contracts\Process\ProcessResult|\Tune\Process\FakeProcessDescription|array|string  $process
     * @return \Tune\Contracts\Process\ProcessResult|\Tune\Process\FakeProcessDescription
     */
