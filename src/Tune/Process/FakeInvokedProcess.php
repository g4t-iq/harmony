...
use Tune\Contracts\Process\InvokedProcess as InvokedProcessContract;
...
class FakeInvokedProcess implements InvokedProcessContract
{
     ...
     *
     * @var \Tune\Process\FakeProcessDescription
     */
    protected $process;
     ...
     * @param  \Tune\Process\FakeProcessDescription  $process
     * @return void
     */
