...
trait ManagesComponents
{
     ...
     *
     * @param  \Tune\Contracts\View\View|\Tune\Contracts\Support\Htmlable|\Closure|string  $view
     * @param  array  $data
     * @return void
     */
