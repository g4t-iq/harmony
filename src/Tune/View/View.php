...
use Tune\Contracts\Support\MessageProvider;
use Tune\Contracts\Support\Renderable;
use Tune\Contracts\View\Engine;
use Tune\Contracts\View\View as ViewContract;
...
class View implements ArrayAccess, Htmlable, ViewContract
{
     ...
     *
     * @var \Tune\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param  \Tune\View\Factory  $factory
     * @param  \Tune\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     * @return void
     ...
     *
     * @param  \Tune\Contracts\Support\MessageProvider|array  $provider
     * @param  string  $bag
     * @return $this
     */
     ...
     *
     * @param  \Tune\Contracts\Support\MessageProvider|array|string  $provider
