...
namespace Tune\View\Engines;

use Tune\Filesystem\Filesystem;
use Tune\Http\Exceptions\HttpResponseException;
use Tune\View\Compilers\CompilerInterface;
use Tune\View\ViewException;
...
class CompilerEngine extends PhpEngine
{
     ...
     *
     * @var \Tune\View\Compilers\CompilerInterface
     */
    protected $compiler;
     ...
     *
     * @param  \Tune\View\Compilers\CompilerInterface  $compiler
     ...
     *
     * @return \Tune\View\Compilers\CompilerInterface
     */
