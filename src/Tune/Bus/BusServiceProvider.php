...
use Tune\Contracts\Bus\Dispatcher as DispatcherContract;
use Tune\Contracts\Bus\QueueingDispatcher as QueueingDispatcherContract;
use Tune\Contracts\Queue\Factory as QueueFactoryContract;
