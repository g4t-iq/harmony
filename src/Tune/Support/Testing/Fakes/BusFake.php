...
class BusFake implements Fake, QueueingDispatcher
{
     ...
     *
     * @var \Tune\Contracts\Bus\QueueingDispatcher
     */
    public $dispatcher;
     ...
     *
     * @param  \Tune\Contracts\Bus\QueueingDispatcher  $dispatcher
     ...
     *
     * @param  \Tune\Bus\PendingBatch  $pendingBatch
     * @return \Tune\Bus\Batch
     */
