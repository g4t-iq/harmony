 ...
 *
 * @method \Tune\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Tune\Support\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Tune\Support\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \Tune\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Tune\Support\Carbon createFromTimeString($time, $tz = null)
 * @method \Tune\Support\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \Tune\Support\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \Tune\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \Tune\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Tune\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 ...
 * @method \Tune\Support\Carbon fromSerialized($value)
 ...
 * @method \Tune\Support\Carbon|null getTestNow()
 ...
 * @method \Tune\Support\Carbon instance($date)
 ...
 * @method \Tune\Support\Carbon|null make($var)
 * @method \Tune\Support\Carbon maxValue()
 * @method \Tune\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \Tune\Support\Carbon now($tz = null)
 * @method \Tune\Support\Carbon parse($time = null, $tz = null)
 ...
 * @method \Tune\Support\Carbon today($tz = null)
 * @method \Tune\Support\Carbon tomorrow($tz = null)
 ...
 * @method \Tune\Support\Carbon yesterday($tz = null)
 */
class DateFactory
{
    /**
