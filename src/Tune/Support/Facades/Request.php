...
/**
 * @method static \Tune\Http\Request capture()
 * @method static \Tune\Http\Request instance()
 ...
 * @method static \Tune\Http\Request merge(array $input)
 * @method static \Tune\Http\Request mergeIfMissing(array $input)
 * @method static \Tune\Http\Request replace(array $input)
 * @method static mixed get(string $key, mixed $default = null)
 * @method static \Symfony\Component\HttpFoundation\InputBag|mixed json(string|null $key = null, mixed $default = null)
 * @method static \Tune\Http\Request createFrom(\Tune\Http\Request $from, \Tune\Http\Request|null $to = null)
 * @method static \Tune\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \Tune\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 ...
 * @method static \Tune\Contracts\Session\Session session()
 * @method static void setHarmonySession(\Tune\Contracts\Session\Session $session)
 * @method static void setRequestLocale(string $locale)
 * @method static void setDefaultRequestLocale(string $locale)
 * @method static mixed user(string|null $guard = null)
 * @method static \Tune\Routing\Route|object|string|null route(string|null $param = null, mixed $default = null)
 * @method static string fingerprint()
 * @method static \Tune\Http\Request setJson(\Symfony\Component\HttpFoundation\InputBag $json)
 * @method static \Closure getUserResolver()
 * @method static \Tune\Http\Request setUserResolver(\Closure $callback)
 * @method static \Closure getRouteResolver()
 * @method static \Tune\Http\Request setRouteResolver(\Closure $callback)
 ...
 * @method static \Tune\Http\Request createFromGlobals()
 * @method static \Tune\Http\Request create(string $uri, string $method = 'GET', array $parameters = [], array $cookies = [], array $files = [], array $server = [], string|resource|null $content = null)
 ...
 * @method static string|array|null old(string|null $key = null, \Tune\Database\Eloquent\Model|string|array|null $default = null)
 ...
 * @method static \Tune\Http\Request|mixed whenHas(string $key, callable $callback, callable|null $default = null)
 ...
 * @method static \Tune\Http\Request|mixed whenFilled(string $key, callable $callback, callable|null $default = null)
 * @method static bool missing(string|array $key)
 * @method static \Tune\Http\Request|mixed whenMissing(string $key, callable $callback, callable|null $default = null)
 * @method static array keys()
 * @method static array all(array|mixed|null $keys = null)
 * @method static mixed input(string|null $key = null, mixed $default = null)
 * @method static \Tune\Support\Stringable str(string $key, mixed $default = null)
 * @method static \Tune\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \Tune\Support\Carbon|null date(string $key, string|null $format = null, string|null $tz = null)
 * @method static object|null enum(string $key, string $enumClass)
 * @method static \Tune\Support\Collection collect(array|string|null $key = null)
 ...
 * @method static \Tune\Http\UploadedFile|\Tune\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static never dd(mixed ...$keys)
 * @method static \Tune\Http\Request dump(mixed $keys = [])
