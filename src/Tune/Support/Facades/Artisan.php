 ...
 * @method static \Tune\Support\Carbon|null commandStartedAt()
 * @method static \Tune\Foundation\Console\ClosureCommand command(string $signature, \Closure $callback)
 ...
 * @method static \Tune\Foundation\Bus\PendingDispatch queue(string $command, array $parameters = [])
 * @method static array all()
 * @method static string output()
 * @method static void bootstrap()
 * @method static void bootstrapWithoutBootingProviders()
 * @method static void setArtisan(\Tune\Console\Application|null $artisan)
 *
 * @see \Tune\Foundation\Console\Kernel
 */
