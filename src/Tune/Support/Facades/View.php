...
/**
 * @method static \Tune\Contracts\View\View file(string $path, \Tune\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \Tune\Contracts\View\View make(string $view, \Tune\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \Tune\Contracts\View\View first(array $views, \Tune\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderWhen(bool $condition, string $view, \Tune\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderUnless(bool $condition, string $view, \Tune\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 * @method static bool exists(string $view)
 * @method static \Tune\Contracts\View\Engine getEngineFromPath(string $path)
 ...
 * @method static \Tune\View\Factory addNamespace(string $namespace, string|array $hints)
 * @method static \Tune\View\Factory prependNamespace(string $namespace, string|array $hints)
 * @method static \Tune\View\Factory replaceNamespace(string $namespace, string|array $hints)
 ...
 * @method static \Tune\View\Engines\EngineResolver getEngineResolver()
 * @method static \Tune\View\ViewFinderInterface getFinder()
 * @method static void setFinder(\Tune\View\ViewFinderInterface $finder)
 ...
 * @method static void setContainer(\Tune\Contracts\Container\Container $container)
 ...
 * @method static void startComponent(\Tune\Contracts\View\View|\Tune\Contracts\Support\Htmlable|\Closure|string $view, array $data = [])
 ...
 * @method static void callComposer(\Tune\Contracts\View\View $view)
 * @method static void callCreator(\Tune\Contracts\View\View $view)
