 ...
 * @method static void callSetUpTestCaseCallbacks(\Tune\Foundation\Testing\TestCase $testCase)
 * @method static void callSetUpTestDatabaseCallbacks(string $database)
 * @method static void callTearDownProcessCallbacks()
 * @method static void callTearDownTestCaseCallbacks(\Tune\Foundation\Testing\TestCase $testCase)
 * @method static mixed option(string $option)
 * @method static string|false token()
 *
 * @see \Tune\Testing\ParallelTesting
 */
class ParallelTesting extends Facade
{
    ...
    {
        return \Tune\Testing\ParallelTesting::class;
    }
}
