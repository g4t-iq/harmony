 ...
 * @method static \Tune\Session\SessionManager extend(string $driver, \Closure $callback)
 * @method static array getDrivers()
 * @method static \Tune\Contracts\Container\Container getContainer()
 * @method static \Tune\Session\SessionManager setContainer(\Tune\Contracts\Container\Container $container)
 * @method static \Tune\Session\SessionManager forgetDrivers()
 ...
 * @method static void setRequestOnHandler(\Tune\Http\Request $request)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \Tune\Session\SessionManager
 */
