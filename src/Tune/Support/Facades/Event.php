...
use Tune\Support\Testing\Fakes\EventFake;
 ...
 * @method static \Tune\Events\Dispatcher setQueueResolver(callable $resolver)
 * @method static array getRawListeners()
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 * @method static \Tune\Support\Testing\Fakes\EventFake except(array|string $eventsToDispatch)
 ...
 * @method static \Tune\Support\Collection dispatched(string $event, callable|null $callback = null)
 * @method static bool hasDispatched(string $event)
 *
 * @see \Tune\Events\Dispatcher
 * @see \Tune\Support\Testing\Fakes\EventFake
 */
class Event extends Facade
{
     ...
     * @return \Tune\Support\Testing\Fakes\EventFake
     */
