...
/**
 * @method static \Tune\Redis\Connections\Connection connection(string|null $name = null)
 * @method static \Tune\Redis\Connections\Connection resolve(string|null $name = null)
 ...
 * @method static \Tune\Redis\RedisManager extend(string $driver, \Closure $callback)
 * @method static void createSubscription(array|string $channels, \Closure $callback, string $method = 'subscribe')
 * @method static \Tune\Redis\Limiters\ConcurrencyLimiterBuilder funnel(string $name)
 * @method static \Tune\Redis\Limiters\DurationLimiterBuilder throttle(string $name)
 ...
 * @method static \Tune\Redis\Connections\Connection setName(string $name)
