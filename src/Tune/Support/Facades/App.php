 ...
 * @method static \Tune\Foundation\Application setBasePath(string $basePath)
 * @method static string path(string $path = '')
 * @method static \Tune\Foundation\Application useAppPath(string $path)
 * @method static string basePath(string $path = '')
 * @method static string bootstrapPath(string $path = '')
 * @method static \Tune\Foundation\Application useBootstrapPath(string $path)
 * @method static string configPath(string $path = '')
 * @method static \Tune\Foundation\Application useConfigPath(string $path)
 * @method static string databasePath(string $path = '')
 * @method static \Tune\Foundation\Application useDatabasePath(string $path)
 * @method static string langPath(string $path = '')
 * @method static \Tune\Foundation\Application useLangPath(string $path)
 * @method static string publicPath(string $path = '')
 * @method static \Tune\Foundation\Application usePublicPath(string $path)
 * @method static string storagePath(string $path = '')
 * @method static \Tune\Foundation\Application useStoragePath(string $path)
 * @method static string resourcePath(string $path = '')
 * @method static string viewPath(string $path = '')
 * @method static string joinPaths(string $basePath, string $path = '')
 * @method static string environmentPath()
 * @method static \Tune\Foundation\Application useEnvironmentPath(string $path)
 * @method static \Tune\Foundation\Application loadEnvironmentFrom(string $file)
 ...
 * @method static \Tune\Support\ServiceProvider register(\Tune\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \Tune\Support\ServiceProvider|null getProvider(\Tune\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\Tune\Support\ServiceProvider|string $provider)
 * @method static \Tune\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static \Tune\Foundation\Application addAbsoluteCachePathPrefix(string $prefix)
 * @method static \Tune\Contracts\Foundation\MaintenanceMode maintenanceMode()
 * @method static bool isDownForMaintenance()
 * @method static never abort(int $code, string $message = '', array $headers = [])
 * @method static \Tune\Foundation\Application terminating(callable|string $callback)
 ...
 * @method static \Tune\Contracts\Container\ContextualBindingBuilder when(array|string $concrete)
 ...
 * @method static \Tune\Foundation\Application getInstance()
 * @method static \Tune\Contracts\Container\Container|\Tune\Foundation\Application setInstance(\Tune\Contracts\Container\Container|null $container = null)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \Tune\Foundation\Application
 */
