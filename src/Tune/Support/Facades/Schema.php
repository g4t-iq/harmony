 ...
 * @method static \Tune\Database\Connection getConnection()
 * @method static \Tune\Database\Schema\Builder setConnection(\Tune\Database\Connection $connection)
 * @method static void blueprintResolver(\Closure $resolver)
 *
 * @see \Tune\Database\Schema\Builder
 */
