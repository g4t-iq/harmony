...
namespace Tune\Filesystem;

use Closure;
use Tune\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use Tune\Contracts\Filesystem\Filesystem as FilesystemContract;
use Tune\Http\File;
use Tune\Http\UploadedFile;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @param  string  $path
     * @param  \Psr\Http\Message\StreamInterface|\Tune\Http\File|\Tune\Http\UploadedFile|string|resource  $contents
     * @param  mixed  $options
     * @return string|bool
     */
     ...
     *
     * @param  \Tune\Http\File|\Tune\Http\UploadedFile|string  $path
     * @param  \Tune\Http\File|\Tune\Http\UploadedFile|string|array|null  $file
     * @param  mixed  $options
     * @return string|false
     */
