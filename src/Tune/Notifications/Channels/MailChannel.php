...
namespace Tune\Notifications\Channels;

use Tune\Config\Repository as ConfigRepository;
use Tune\Container\Container;
use Tune\Contracts\Mail\Factory as MailFactory;
use Tune\Contracts\Mail\Mailable;
use Tune\Contracts\Queue\ShouldQueue;
use Tune\Mail\Markdown;
use Tune\Notifications\Notification;
...
class MailChannel
{
     ...
     *
     * @var \Tune\Contracts\Mail\Factory
     */
    protected $mailer;
     ...
     *
     * @param  \Tune\Contracts\Mail\Factory  $mailer
     * @param  \Tune\Mail\Markdown  $markdown
     * @return void
     */
     ...
     * @param  mixed  $notifiable
     * @param  \Tune\Notifications\Notification  $notification
     * @param  \Tune\Notifications\Messages\MailMessage  $message
     * @return \Closure
     */
    ...
    {
        return [
            '__harmony_notification_id' => $notification->id,
            '__harmony_notification' => get_class($notification),
            '__harmony_notification_queued' => in_array(
                ShouldQueue::class,
     ...
     *
     * @param  \Tune\Mail\Message  $mailMessage
     * @param  mixed  $notifiable
     * @param  \Tune\Notifications\Notification  $notification
     * @param  \Tune\Notifications\Messages\MailMessage  $message
     * @return void
