...
namespace Tune\Routing\Console;

use Tune\Console\Concerns\CreatesMatchingTest;
use Tune\Console\GeneratorCommand;
...
use function Harmony\Prompts\select;
...
class ControllerMakeCommand extends GeneratorCommand
{
    ...
    {
        return file_exists($customPath = $this->harmony->basePath(trim($stub, '/')))
                        ? $customPath
                        : __DIR__.$stub;
    }
