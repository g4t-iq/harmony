...
use Tune\Contracts\Routing\ResponseFactory as FactoryContract;
use Tune\Contracts\View\Factory as ViewFactory;
use Tune\Http\JsonResponse;
use Tune\Http\Response;
use Tune\Routing\Exceptions\StreamedResponseException;
...
class ResponseFactory implements FactoryContract
{
     ...
     *
     * @param  \Tune\Contracts\View\Factory  $view
