...
use Closure;
use Tune\Cache\RateLimiter;
use Tune\Cache\RateLimiting\Unlimited;
use Tune\Http\Exceptions\HttpResponseException;
use Tune\Http\Exceptions\ThrottleRequestsException;
...
class ThrottleRequests
{
     ...
     *
     * @param  \Tune\Cache\RateLimiter  $limiter
     * @return void
     */
     ...
     *
     * @throws \Tune\Http\Exceptions\ThrottleRequestsException
     */
     ...
     * @return \Tune\Http\Exceptions\ThrottleRequestsException|\Tune\Http\Exceptions\HttpResponseException
     */
