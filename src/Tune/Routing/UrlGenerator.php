...
use BackedEnum;
use Closure;
use Tune\Contracts\Routing\UrlGenerator as UrlGeneratorContract;
...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     *
     * @var \Tune\Routing\RouteUrlGenerator|null
     */
     ...
     *
     * @param  \Tune\Routing\RouteCollectionInterface  $routes
     ...
     * @return string
     *
     * @throws \Tune\Routing\Exceptions\UrlGenerationException
     */
     ...
     * @param  string  $root
     * @param  string  $path
     * @param  \Tune\Routing\Route|null  $route
     * @return string
     */
     ...
     *
     * @return \Tune\Routing\RouteUrlGenerator
     */
     ...
     *
     * @return \Tune\Session\Store|null
     */
     ...
     *
     * @param  callable  $keyResolver
     * @return \Tune\Routing\UrlGenerator
     */
