...
use Tune\Contracts\Routing\BindingRegistrar;
use Tune\Contracts\Routing\Registrar as RegistrarContract;
...
use Tune\Routing\Events\PreparingResponse;
use Tune\Routing\Events\ResponsePrepared;
use Tune\Routing\Events\RouteMatched;
use Tune\Routing\Events\Routing;
use Tune\Support\Arr;
use Tune\Support\Collection;
use Tune\Support\Str;
use Tune\Support\Stringable;
...
/**
 * @mixin \Tune\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \Tune\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     * @param  \Tune\Container\Container|null  $container
     * @return void
     */
    ...
    {
        return $this->any($uri, '\Tune\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\Tune\Routing\ViewController')
                ->setDefaults([
                    'view' => $view,
                    'data' => $data,
     ...
     *
     * @param  \Tune\Support\Collection  $middlewares
     * @return array
     */
     ...
     *
     * @return \Tune\Routing\Route|null
     */
     ...
     *
     * @return \Tune\Routing\RouteCollectionInterface
     */
