...
use Tune\Routing\Contracts\CallableDispatcher;
use Tune\Routing\Contracts\ControllerDispatcher as ControllerDispatcherContract;
use Tune\Routing\Controllers\HasMiddleware;
use Tune\Routing\Matching\HostValidator;
use Tune\Routing\Matching\MethodValidator;
use Tune\Routing\Matching\SchemeValidator;
use Tune\Routing\Matching\UriValidator;
...
class Route
{
    ...
    public function getMissing()
    {
        ...
        return is_string($missing) &&
            Str::startsWith($missing, [
                'O:47:"Harmony\\SerializableClosure\\SerializableClosure',
                'O:55:"Harmony\\SerializableClosure\\UnsignedSerializableClosure',
     ...
     *
     * @return \Tune\Routing\Contracts\ControllerDispatcher
     */
