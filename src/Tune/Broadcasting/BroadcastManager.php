...
use Tune\Broadcasting\Broadcasters\AblyBroadcaster;
use Tune\Broadcasting\Broadcasters\LogBroadcaster;
use Tune\Broadcasting\Broadcasters\NullBroadcaster;
use Tune\Broadcasting\Broadcasters\PusherBroadcaster;
use Tune\Broadcasting\Broadcasters\RedisBroadcaster;
use Tune\Bus\UniqueLock;
use Tune\Contracts\Broadcasting\Factory as FactoryContract;
use Tune\Contracts\Broadcasting\ShouldBeUnique;
use Tune\Contracts\Broadcasting\ShouldBroadcastNow;
...
/**
 * @mixin \Tune\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param  \Tune\Contracts\Container\Container  $app
     * @return void
     */
    ...
    public function routes(array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\Tune\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
