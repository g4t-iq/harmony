...
namespace Tune\Broadcasting\Broadcasters;

use Closure;
use Exception;
use Tune\Container\Container;
use Tune\Contracts\Broadcasting\Broadcaster as BroadcasterContract;
...
abstract class Broadcaster implements BroadcasterContract
{
     ...
     *
     * @var \Tune\Contracts\Routing\BindingRegistrar
     */
     ...
     *
     * @param  \Tune\Contracts\Broadcasting\HasBroadcastChannel|string  $channel
     ...
     *
     * @return \Tune\Contracts\Routing\BindingRegistrar
     */
