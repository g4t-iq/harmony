...
use Tune\Foundation\Events\MaintenanceModeEnabled;
use Tune\Foundation\Exceptions\RegisterErrorViewPaths;
...
class DownCommand extends Command
{
    ...
    public function handle()
    {
        try {
            ...
            $this->harmony->maintenanceMode()->activate($this->getDownFilePayload());
            ...
            $this->harmony->get('events')->dispatch(new MaintenanceModeEnabled());
    ...
    {
        try {
            return $this->harmony->make(PreventRequestsDuringMaintenance::class)->getExcludedPaths();
        } catch (Throwable) {
            return [];
        }
    }
