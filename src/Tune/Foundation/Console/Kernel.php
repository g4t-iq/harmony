...
use Tune\Console\Application as Artisan;
use Tune\Console\Command;
use Tune\Console\Events\CommandFinished;
use Tune\Console\Events\CommandStarting;
use Tune\Console\Scheduling\Schedule;
...
class Kernel implements KernelContract
{
     ...
     *
     * @var \Tune\Console\Application|null
     */
    protected $artisan;
    ...
    protected $bootstrappers = [
        ...
        \Tune\Foundation\Bootstrap\SetRequestForConsole::class,
    ...
    /**
     * Re-route the Symfony command events to their Harmony counterparts.
     *
     * @internal
     *
     * @return $this
     ...
     * @return \Tune\Foundation\Console\ClosureCommand
     */
    ...
    public function bootstrapWithoutBootingProviders()
    {
        $this->app->bootstrapWith(
            collect($this->bootstrappers())->reject(function ($bootstrapper) {
                return $bootstrapper === \Tune\Foundation\Bootstrap\BootProviders::class;
            })->all()
        );
    }
     ...
     *
     * @return \Tune\Console\Application
     */
     ...
     *
     * @param  \Tune\Console\Application|null  $artisan
     * @return void
     */
