...
use Tune\Contracts\Broadcasting\Broadcaster;
...
class ChannelListCommand extends Command
{
     ...
     *
     * @param  \Tune\Contracts\Broadcasting\Broadcaster
     * @return void
     */
    public function handle(Broadcaster $broadcaster)
    {
        ...
        if (! $this->harmony->providerIsLoaded('App\Providers\BroadcastServiceProvider') &&
            file_exists($this->harmony->path('Providers/BroadcastServiceProvider.php'))) {
     ...
     *
     * @param  \Tune\Support\Collection  $channels
     * @return array
     */
