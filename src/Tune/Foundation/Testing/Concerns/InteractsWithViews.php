...
use Tune\Support\Facades\View as ViewFacade;
use Tune\Support\MessageBag;
use Tune\Support\ViewErrorBag;
use Tune\Testing\TestComponent;
use Tune\Testing\TestView;
use Tune\View\View;
...
trait InteractsWithViews
{
    ...
    protected function blade(string $template, $data = [])
    {
        ...
        $tempFileInfo = pathinfo(tempnam($tempDirectory, 'harmony-blade'));
     ...
     * @param  \Tune\Contracts\Support\Arrayable|array  $data
     * @return \Tune\Testing\TestComponent
     */
