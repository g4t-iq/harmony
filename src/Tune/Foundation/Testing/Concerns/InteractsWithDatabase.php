...
use Tune\Support\Facades\DB;
use Tune\Testing\Constraints\CountInDatabase;
use Tune\Testing\Constraints\HasInDatabase;
use Tune\Testing\Constraints\NotSoftDeletedInDatabase;
use Tune\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param  \Tune\Database\Eloquent\Model|string  $table
     * @param  array  $data
