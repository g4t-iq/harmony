...
use Closure;
use Exception;
use Tune\Auth\Access\AuthorizationException;
use Tune\Auth\AuthenticationException;
use Tune\Console\View\Components\BulletList;
use Tune\Console\View\Components\Error;
use Tune\Contracts\Container\Container;
use Tune\Contracts\Debug\ExceptionHandler as ExceptionHandlerContract;
use Tune\Contracts\Foundation\ExceptionRenderer;
use Tune\Contracts\Support\Responsable;
use Tune\Database\Eloquent\ModelNotFoundException;
use Tune\Database\MultipleRecordsFoundException;
use Tune\Database\RecordsNotFoundException;
use Tune\Http\Exceptions\HttpResponseException;
use Tune\Http\JsonResponse;
use Tune\Http\RedirectResponse;
use Tune\Http\Response;
...
use Tune\Support\Facades\Auth;
use Tune\Support\Reflector;
use Tune\Support\Traits\ReflectsClosures;
use Tune\Support\ViewErrorBag;
...
class Handler implements ExceptionHandlerContract
{
     ...
     *
     * @var \Tune\Contracts\Container\Container
     */
    protected $container;
     ...
     *
     * @var \Tune\Foundation\Exceptions\ReportableHandler[]
     */
     ...
     *
     * @param  \Tune\Contracts\Container\Container  $container
     * @return void
     */
     ...
     * @return \Tune\Foundation\Exceptions\ReportableHandler
     */
     ...
     * @param  \Tune\Http\Request  $request
     * @param  \Throwable  $e
     * @return \Tune\Http\Response|\Tune\Http\JsonResponse|\Tune\Http\RedirectResponse
     */
     ...
     *
     * @param  \Tune\Http\Request  $request
     * @param  \Tune\Auth\AuthenticationException  $exception
     * @return \Tune\Http\Response|\Tune\Http\JsonResponse|\Tune\Http\RedirectResponse
     */
     ...
     *
     * @param  \Tune\Validation\ValidationException  $e
     * @param  \Tune\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \Tune\Http\Request  $request
     * @param  \Tune\Validation\ValidationException  $exception
     * @return \Tune\Http\Response|\Tune\Http\JsonResponse|\Tune\Http\RedirectResponse
     */
    ...
    protected function prepareResponse($request, Throwable $e)
    {
        if (! $this->isHttpException($e) && config('app.debug')) {
            return $this->toTuneResponse($this->convertExceptionToResponse($e), $e)->prepare($request);
        }
    ...
    /**
     * Map the given exception into an Tune response.
     *
     * @param  \Symfony\Component\HttpFoundation\Response  $response
     * @param  \Throwable  $e
     * @return \Tune\Http\Response|\Tune\Http\RedirectResponse
     */
    protected function toTuneResponse($response, Throwable $e)
    {
