...
namespace Tune\Foundation\Http;

use Carbon\CarbonInterval;
use DateTimeInterface;
use Tune\Contracts\Debug\ExceptionHandler;
use Tune\Contracts\Foundation\Application;
use Tune\Contracts\Http\Kernel as KernelContract;
use Tune\Foundation\Http\Events\RequestHandled;
use Tune\Routing\Pipeline;
...
class Kernel implements KernelContract
{
    ...
    protected $bootstrappers = [
        \Tune\Foundation\Bootstrap\LoadEnvironmentVariables::class,
        \Tune\Foundation\Bootstrap\LoadConfiguration::class,
        \Tune\Foundation\Bootstrap\HandleExceptions::class,
        \Tune\Foundation\Bootstrap\RegisterFacades::class,
        \Tune\Foundation\Bootstrap\RegisterProviders::class,
        \Tune\Foundation\Bootstrap\BootProviders::class,
    ];
    ...
    protected $middlewarePriority = [
        \Tune\Foundation\Http\Middleware\HandlePrecognitiveRequests::class,
        \Tune\Cookie\Middleware\EncryptCookies::class,
        \Tune\Cookie\Middleware\AddQueuedCookiesToResponse::class,
        \Tune\Session\Middleware\StartSession::class,
        \Tune\View\Middleware\ShareErrorsFromSession::class,
        \Tune\Contracts\Auth\Middleware\AuthenticatesRequests::class,
        \Tune\Routing\Middleware\ThrottleRequests::class,
        \Tune\Routing\Middleware\ThrottleRequestsWithRedis::class,
        \Tune\Contracts\Session\Middleware\AuthenticatesSessions::class,
        \Tune\Routing\Middleware\SubstituteBindings::class,
        \Tune\Auth\Middleware\Authorize::class,
    ];
     ...
     *
     * @return \Tune\Support\Carbon|null
     */
