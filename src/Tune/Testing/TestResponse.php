...
use ArrayAccess;
use Closure;
use Tune\Contracts\Support\MessageBag;
...
use Tune\Testing\Assert as PHPUnit;
use Tune\Testing\Constraints\SeeInOrder;
use Tune\Testing\Fluent\AssertableJson;
use LogicException;
...
class TestResponse implements ArrayAccess
{
     ...
     *
     * @return \Tune\Testing\AssertableJsonString
     *
     * @throws \Throwable
     */
     ...
     *
     * @param  \Tune\Support\Collection  $exceptions
     * @return $this
     */
