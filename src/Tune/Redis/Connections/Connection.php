...
namespace Tune\Redis\Connections;

use Closure;
use Tune\Contracts\Events\Dispatcher;
use Tune\Redis\Events\CommandExecuted;
use Tune\Redis\Limiters\ConcurrencyLimiterBuilder;
use Tune\Redis\Limiters\DurationLimiterBuilder;
...
abstract class Connection
{
     ...
     *
     * @param  string  $name
     * @return \Tune\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     *
     * @param  string  $name
     * @return \Tune\Redis\Limiters\DurationLimiterBuilder
     */
