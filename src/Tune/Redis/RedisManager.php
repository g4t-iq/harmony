...
namespace Tune\Redis;

use Closure;
use Tune\Contracts\Redis\Factory;
use Tune\Redis\Connections\Connection;
use Tune\Redis\Connectors\PhpRedisConnector;
use Tune\Redis\Connectors\PredisConnector;
use Tune\Support\Arr;
use Tune\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \Tune\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @param  \Tune\Redis\Connections\Connection  $connection
     * @param  string  $name
     * @return \Tune\Redis\Connections\Connection
     */
     ...
     *
     * @return \Tune\Contracts\Redis\Connector|null
     */
