...
namespace Tune\Redis\Limiters;

use Tune\Contracts\Redis\LimiterTimeoutException;
...
class DurationLimiterBuilder
{
     ...
     *
     * @var \Tune\Redis\Connections\Connection
     */
    public $connection;
     ...
     * @return mixed
     *
     * @throws \Tune\Contracts\Redis\LimiterTimeoutException
     */
