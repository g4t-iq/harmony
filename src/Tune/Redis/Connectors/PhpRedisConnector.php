...
use Tune\Redis\Connections\PhpRedisClusterConnection;
use Tune\Redis\Connections\PhpRedisConnection;
use Tune\Support\Arr;
use Tune\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \Tune\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \Tune\Redis\Connections\PhpRedisClusterConnection
     */
