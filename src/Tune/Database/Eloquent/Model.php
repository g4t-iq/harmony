...
use Tune\Database\ConnectionResolverInterface as Resolver;
...
use Tune\Support\Collection as BaseCollection;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     *
     * @var \Tune\Database\ConnectionResolverInterface
     */
     ...
     * @return $this
     *
     * @throws \Tune\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \Tune\Database\Eloquent\Collection<int, static>
     */
     ...
     *
     * @param  \Tune\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     * @return \Tune\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \Tune\Database\Eloquent\JsonEncodingException
     */
     ...
     *
     * @param  \Tune\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \Tune\Database\Connection
     */
     ...
     *
     * @return \Tune\Database\ConnectionResolverInterface|null
     */
     ...
     *
     * @param  \Tune\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * @return \Tune\Database\Eloquent\Model|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \Tune\Database\Eloquent\Model|\Tune\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Tune\Database\Eloquent\Relations\Relation
     */
