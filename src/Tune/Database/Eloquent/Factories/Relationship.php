...
use Tune\Database\Eloquent\Relations\HasOneOrMany;
use Tune\Database\Eloquent\Relations\MorphOneOrMany;
...
class Relationship
{
     ...
     *
     * @var \Tune\Database\Eloquent\Factories\Factory
     */
    protected $factory;
     ...
     *
     * @param  \Tune\Database\Eloquent\Factories\Factory  $factory
     ...
     *
     * @param  \Tune\Support\Collection  $recycle
     * @return $this
     */
