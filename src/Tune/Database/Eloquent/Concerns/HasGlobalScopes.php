...
use Closure;
use Tune\Database\Eloquent\Scope;
...
trait HasGlobalScopes
{
     ...
     *
     * @param  \Tune\Database\Eloquent\Scope|\Closure|string  $scope
     * @param  \Tune\Database\Eloquent\Scope|\Closure|null  $implementation
     * @return mixed
     *
     ...
     *
     * @param  \Tune\Database\Eloquent\Scope|string  $scope
     * @return \Tune\Database\Eloquent\Scope|\Closure|null
     */
