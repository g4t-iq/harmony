...
use Tune\Contracts\Database\Eloquent\CastsInboundAttributes;
use Tune\Contracts\Support\Arrayable;
use Tune\Database\Eloquent\Casts\AsArrayObject;
use Tune\Database\Eloquent\Casts\AsCollection;
use Tune\Database\Eloquent\Casts\AsEncryptedArrayObject;
use Tune\Database\Eloquent\Casts\AsEncryptedCollection;
use Tune\Database\Eloquent\Casts\AsEnumArrayObject;
use Tune\Database\Eloquent\Casts\AsEnumCollection;
use Tune\Database\Eloquent\Casts\Attribute;
use Tune\Database\Eloquent\Casts\Json;
use Tune\Database\Eloquent\InvalidCastException;
use Tune\Database\Eloquent\JsonEncodingException;
use Tune\Database\Eloquent\MissingAttributeException;
use Tune\Database\Eloquent\Relations\Relation;
use Tune\Database\LazyLoadingViolationException;
use Tune\Support\Arr;
use Tune\Support\Carbon;
use Tune\Support\Collection as BaseCollection;
use Tune\Support\Exceptions\MathException;
...
trait HasAttributes
{
     ...
     *
     * @var \Tune\Contracts\Encryption\Encrypter|null
     */
     ...
     * @return null
     *
     * @throws \Tune\Database\Eloquent\MissingAttributeException
     */
     ...
     *
     * @param  \Tune\Contracts\Encryption\Encrypter|null  $encrypter
     * @return void
     */
     ...
     * @return bool
     *
     * @throws \Tune\Database\Eloquent\InvalidCastException
     */
