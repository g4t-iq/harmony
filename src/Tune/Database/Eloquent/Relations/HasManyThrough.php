...
class HasManyThrough extends Relation
{
     ...
     *
     * @param  \Tune\Database\Eloquent\Builder|null  $query
     * @return void
     */
    ...
    protected function buildDictionary(Collection $results)
    {
        ...
        foreach ($results as $result) {
            $dictionary[$result->harmony_through_key][] = $result;
        }
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Tune\Database\Eloquent\Model|\Tune\Database\Eloquent\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Tune\Database\Eloquent\Model|\Tune\Database\Eloquent\Collection
     *
     * @throws \Tune\Database\Eloquent\ModelNotFoundException<\Tune\Database\Eloquent\Model>
     */
     ...
     * @param  \Closure|array  $columns
     * @param  \Closure|null  $callback
     * @return \Tune\Database\Eloquent\Model|\Tune\Database\Eloquent\Collection|mixed
     */
    ...
    protected function shouldSelect(array $columns = ['*'])
    {
        ...
        return array_merge($columns, [$this->getQualifiedFirstKeyName().' as harmony_through_key']);
    }
