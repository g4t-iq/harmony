...
namespace Tune\Database\Eloquent\Relations\Concerns;
...
trait CanBeOneOfMany
{
     ...
     *
     * @var \Tune\Database\Eloquent\Builder|null
     */
     ...
     *
     * @param  \Tune\Database\Eloquent\Builder  $parent
     * @param  \Tune\Database\Eloquent\Builder  $subQuery
     * @param  string  $on
     * @return void
     */
     ...
     *
     * @return \Tune\Database\Eloquent\Builder|void
     */
