...
use Closure;
use Exception;
use Tune\Contracts\Database\Eloquent\Builder as BuilderContract;
use Tune\Contracts\Database\Query\Expression;
use Tune\Contracts\Support\Arrayable;
use Tune\Database\Concerns\BuildsQueries;
use Tune\Database\Eloquent\Concerns\QueriesRelationships;
use Tune\Database\Eloquent\Relations\BelongsToMany;
use Tune\Database\Eloquent\Relations\Relation;
use Tune\Database\Query\Builder as QueryBuilder;
use Tune\Database\RecordsNotFoundException;
use Tune\Database\UniqueConstraintViolationException;
 ...
 *
 * @mixin \Tune\Database\Query\Builder
 */
class Builder implements BuilderContract
{
     ...
     *
     * @var \Tune\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \Tune\Database\Eloquent\Model
     */
    protected $model;
     ...
     * @return \Tune\Database\Eloquent\Model|static
     */
     ...
     * @param  \Tune\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \Tune\Database\Eloquent\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \Tune\Database\Eloquent\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\Tune\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\Tune\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     * @return \Tune\Database\Eloquent\Model|\Tune\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     *
     * @param  \Tune\Contracts\Support\Arrayable|array  $ids
     * @param  array|string  $columns
     * @return \Tune\Database\Eloquent\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return \Tune\Database\Eloquent\Model|\Tune\Database\Eloquent\Collection|static|static[]
     *
     ...
     * @return \Tune\Database\Eloquent\Model|\Tune\Database\Eloquent\Collection|static[]|static|mixed
     */
     ...
     * @param  \Closure|array|string  $columns
     * @param  \Closure|null  $callback
     * @return \Tune\Database\Eloquent\Model|static|mixed
     */
     ...
     *
     * @param  array|string  $columns
     * @return \Tune\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \Tune\Database\Eloquent\Relations\Relation
     */
     ...
     *
     * @param  array  $attributes
     * @return \Tune\Database\Eloquent\Model|$this
     */
     ...
     *
     * @param  array|\Tune\Contracts\Database\Query\Expression  $columns
     * @return array
     */
