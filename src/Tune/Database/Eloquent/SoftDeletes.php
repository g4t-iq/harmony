...
/**
 * @method static \Tune\Database\Eloquent\Builder|\Tune\Database\Query\Builder withTrashed(bool $withTrashed = true)
 * @method static \Tune\Database\Eloquent\Builder|\Tune\Database\Query\Builder onlyTrashed()
 * @method static \Tune\Database\Eloquent\Builder|\Tune\Database\Query\Builder withoutTrashed()
 */
trait SoftDeletes
{
    /**
