...
use Tune\Database\Eloquent\MassPrunable;
use Tune\Database\Eloquent\Prunable;
use Tune\Database\Eloquent\SoftDeletes;
use Tune\Database\Events\ModelPruningFinished;
use Tune\Database\Events\ModelPruningStarting;
use Tune\Database\Events\ModelsPruned;
...
class PruneCommand extends Command
{
    ...
    protected function models()
    {
        ...
        return collect((new Finder)->in($this->getDefaultPath())->files()->name('*.php'))
            ->map(function ($model) {
                $namespace = $this->harmony->getNamespace();
