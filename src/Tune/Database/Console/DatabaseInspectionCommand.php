...
use Tune\Database\MySqlConnection;
use Tune\Database\PostgresConnection;
use Tune\Database\QueryException;
...
abstract class DatabaseInspectionCommand extends Command
{
     ...
     *
     * @param  \Tune\Support\Composer|null  $composer
     * @return void
     */
    public function __construct(Composer $composer = null)
    {
        ...
        $this->composer = $composer ?? $this->harmony->make(Composer::class);
    }
