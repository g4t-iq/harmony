...
class ShowModelCommand extends DatabaseInspectionCommand
{
    ...
    {
        $listeners = $this->getHarmony()->make('events')->getRawListeners();
     ...
     * @param  string  $table
     * @param  string  $policy
     * @param  \Tune\Support\Collection  $attributes
     * @param  \Tune\Support\Collection  $relations
     * @param  \Tune\Support\Collection  $observers
     * @return void
     */
     ...
     * @return string
     *
     * @see \Tune\Console\GeneratorCommand
     */
    protected function qualifyModel(string $model)
    {
        ...
        $rootNamespace = $this->harmony->getNamespace();
