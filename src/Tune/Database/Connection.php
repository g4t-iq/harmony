...
use Tune\Database\Events\QueryExecuted;
use Tune\Database\Events\StatementPrepared;
use Tune\Database\Events\TransactionBeginning;
use Tune\Database\Events\TransactionCommitted;
use Tune\Database\Events\TransactionCommitting;
use Tune\Database\Events\TransactionRolledBack;
use Tune\Database\Query\Builder as QueryBuilder;
use Tune\Database\Query\Expression;
use Tune\Database\Query\Grammars\Grammar as QueryGrammar;
use Tune\Database\Query\Processors\Processor;
use Tune\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \Tune\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \Tune\Database\DatabaseTransactionsManager
     */
     ...
     *
     * @return \Tune\Database\Schema\Grammars\Grammar|null
     */
     ...
     *
     * @return \Tune\Database\Schema\Builder
     */
     ...
     *
     * @param  \Closure|\Tune\Database\Query\Builder|\Tune\Contracts\Database\Query\Expression|string  $table
     ...
     * @return mixed
     *
     * @throws \Tune\Database\MultipleColumnsSelectedException
     */
     ...
     * @return mixed
     *
     * @throws \Tune\Database\QueryException
     */
     ...
     *
     * @param  \Tune\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \Tune\Database\LostConnectionException
     */
     ...
     *
     * @param  \Tune\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @return \Tune\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param  \Tune\Database\Schema\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @param  \Tune\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @return \Tune\Contracts\Events\Dispatcher
     */
     ...
     *
     * @param  \Tune\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
