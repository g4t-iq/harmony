...
namespace Tune\Database\Schema\Grammars;

use Doctrine\DBAL\Schema\AbstractSchemaManager as SchemaManager;
use Doctrine\DBAL\Schema\TableDiff;
use Tune\Contracts\Database\Query\Expression;
use Tune\Database\Concerns\CompilesJsonPaths;
use Tune\Database\Connection;
use Tune\Database\Grammar as BaseGrammar;
...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Tune\Database\Schema\Blueprint  $blueprint
     * @param  \Tune\Support\Fluent  $command
     * @param  \Tune\Database\Connection  $connection
     * @return array|string
     */
     ...
     *
     * @param  \Tune\Support\Fluent  $column
     * @return string
     */
     ...
     * @param  \Tune\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \Tune\Support\Fluent|null
     */
     ...
     *
     * @param  \Tune\Support\Fluent|\Tune\Contracts\Database\Query\Expression|string  $value
