...
namespace Tune\Database\Schema;

use BadMethodCallException;
use Closure;
use Tune\Database\Connection;
use Tune\Database\Eloquent\Concerns\HasUlids;
use Tune\Database\Query\Expression;
use Tune\Database\Schema\Grammars\Grammar;
use Tune\Database\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \Tune\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     * @return \Tune\Database\Schema\IndexDefinition
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Tune\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Tune\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Tune\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \Tune\Database\Schema\ColumnDefinition  $definition
     * @return \Tune\Database\Schema\ColumnDefinition
     */
