...
use Tune\Pagination\Cursor;
use Tune\Pagination\CursorPaginator;
use Tune\Pagination\LengthAwarePaginator;
...
trait BuildsQueries
{
     ...
     * @return \Tune\Database\Eloquent\Model|object|static|null
     */
     ...
     *
     * @param  \Tune\Database\Query\Builder|\Tune\Database\Eloquent\Builder  $builder
     ...
     *
     * @param  \Tune\Support\Collection  $items
     * @param  int  $total
     * @param  int  $perPage
     * @param  int  $currentPage
     * @param  array  $options
     * @return \Tune\Pagination\LengthAwarePaginator
     */
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \Tune\Pagination\Paginator
     */
     ...
     * @param  \Tune\Support\Collection  $items
     * @param  int  $perPage
     * @param  \Tune\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \Tune\Pagination\CursorPaginator
     */
