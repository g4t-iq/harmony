...
namespace Tune\Database\Migrations;

use Doctrine\DBAL\Schema\SchemaException;
use Tune\Console\View\Components\BulletList;
use Tune\Console\View\Components\Error;
use Tune\Console\View\Components\Info;
use Tune\Console\View\Components\Task;
use Tune\Console\View\Components\TwoColumnDetail;
use Tune\Contracts\Events\Dispatcher;
use Tune\Database\ConnectionResolverInterface as Resolver;
use Tune\Database\Events\MigrationEnded;
use Tune\Database\Events\MigrationsEnded;
use Tune\Database\Events\MigrationsStarted;
use Tune\Database\Events\MigrationStarted;
use Tune\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var \Tune\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @var array<string, \Tune\Database\Migrations\Migration|null>
     */
     ...
     *
     * @param  \Tune\Database\Migrations\MigrationRepositoryInterface  $repository
     * @param  \Tune\Database\ConnectionResolverInterface  $resolver
     * @param  \Tune\Filesystem\Filesystem  $files
     * @param  \Tune\Contracts\Events\Dispatcher|null  $dispatcher
     * @return void
     */
     ...
     *
     * @return \Tune\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \Tune\Filesystem\Filesystem
     */
     ...
     *
     * @param  \Tune\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
