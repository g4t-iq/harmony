...
use Tune\Database\Console\Migrations\FreshCommand;
use Tune\Database\Console\Migrations\InstallCommand;
use Tune\Database\Console\Migrations\MigrateCommand;
use Tune\Database\Console\Migrations\MigrateMakeCommand;
use Tune\Database\Console\Migrations\RefreshCommand;
use Tune\Database\Console\Migrations\ResetCommand;
use Tune\Database\Console\Migrations\RollbackCommand;
use Tune\Database\Console\Migrations\StatusCommand;
use Tune\Database\Migrations\DatabaseMigrationRepository;
use Tune\Database\Migrations\MigrationCreator;
