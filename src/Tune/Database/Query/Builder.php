...
use Tune\Contracts\Database\Query\Builder as BuilderContract;
use Tune\Contracts\Database\Query\ConditionExpression;
use Tune\Contracts\Database\Query\Expression as ExpressionContract;
use Tune\Contracts\Support\Arrayable;
use Tune\Database\Concerns\BuildsQueries;
use Tune\Database\Concerns\ExplainsQueries;
use Tune\Database\ConnectionInterface;
use Tune\Database\Eloquent\Builder as EloquentBuilder;
use Tune\Database\Eloquent\Relations\Relation;
use Tune\Database\Query\Grammars\Grammar;
use Tune\Database\Query\Processors\Processor;
use Tune\Pagination\Paginator;
use Tune\Support\Arr;
use Tune\Support\Collection;
use Tune\Support\LazyCollection;
...
class Builder implements BuilderContract
{
     ...
     *
     * @var \Tune\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \Tune\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \Tune\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \Tune\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     *
     * @param  \Tune\Database\ConnectionInterface  $connection
     * @param  \Tune\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \Tune\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\Tune\Database\Query\Builder|\Tune\Database\Eloquent\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\Tune\Database\Query\Builder|\Tune\Database\Eloquent\Builder|string  $table
     ...
     *
     * @param  \Tune\Contracts\Database\Query\Expression|string  $table
     ...
     *
     * @param  \Tune\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \Tune\Database\Query\JoinClause
     */
     ...
     *
     * @param  \Closure|string|array|\Tune\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Tune\Contracts\Database\Query\Expression|string  $column
     * @param  mixed  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @param  string  $column
     * @param  \Tune\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Tune\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Tune\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  \Tune\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     * @param  \Tune\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure||\Tune\Database\Query\Builder|\Tune\Database\Eloquent\Builder  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  array|\Tune\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \Tune\Contracts\Database\Query\Expression|\Closure|string  $column
     ...
     *
     * @param  \Closure|\Tune\Database\Query\Builder|\Tune\Database\Eloquent\Builder|\Tune\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\Tune\Database\Query\Builder|\Tune\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Tune\Database\Query\Builder|\Tune\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Tune\Database\Query\Builder|\Tune\Database\Eloquent\Builder  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \Tune\Database\RecordsNotFoundException
     * @throws \Tune\Database\MultipleRecordsFoundException
     */
     ...
     * @return \Tune\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Tune\Contracts\Pagination\Paginator
     */
     ...
     * @param  \Tune\Pagination\Cursor|string|null  $cursor
     * @return \Tune\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @return \Tune\Support\LazyCollection
     */
     ...
     *
     * @param  \Tune\Contracts\Database\Query\Expression|string  $columns
     * @return int
     */
     ...
     *
     * @param  mixed  $value
     * @return \Tune\Contracts\Database\Query\Expression
     */
     ...
     *
     * @return \Tune\Database\ConnectionInterface
     */
     ...
     *
     * @return \Tune\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Tune\Database\Query\Grammars\Grammar
     */
