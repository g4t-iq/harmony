...
use Tune\Contracts\Translation\Translator;
use Tune\Contracts\Validation\DataAwareRule;
use Tune\Contracts\Validation\ImplicitRule;
use Tune\Contracts\Validation\Rule as RuleContract;
use Tune\Contracts\Validation\Validator as ValidatorContract;
use Tune\Contracts\Validation\ValidatorAwareRule;
use Tune\Support\Arr;
use Tune\Support\Fluent;
use Tune\Support\MessageBag;
use Tune\Support\Str;
use Tune\Support\ValidatedInput;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \Tune\Contracts\Translation\Translator
     */
     ...
     *
     * @var \Tune\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @param  \Tune\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @return \Tune\Support\ValidatedInput|array
     */
     ...
     * @param  string  $attribute
     * @param  mixed  $value
     * @param  \Tune\Contracts\Validation\Rule  $rule
     * @return void
     */
     ...
     *
     * @return \Tune\Support\MessageBag
     */
     ...
     *
     * @param  string  $attribute
     * @return \Tune\Support\Fluent|array|mixed
     */
     ...
     * @return \Tune\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \Tune\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \Tune\Contracts\Translation\Translator
     */
