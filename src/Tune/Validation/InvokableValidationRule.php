...
use Tune\Contracts\Validation\InvokableRule;
use Tune\Contracts\Validation\Rule;
use Tune\Contracts\Validation\ValidationRule;
use Tune\Contracts\Validation\ValidatorAwareRule;
use Tune\Translation\CreatesPotentiallyTranslatedStrings;
...
class InvokableValidationRule implements Rule, ValidatorAwareRule
{
     ...
     *
     * @var \Tune\Contracts\Validation\ValidationRule|\Tune\Contracts\Validation\InvokableRule
     */
    protected $invokable;
     ...
     *
     * @param  \Tune\Contracts\Validation\ValidationRule|\Tune\Contracts\Validation\InvokableRule  $invokable
     * @return void
     */
     ...
     *
     * @param  \Tune\Contracts\Validation\ValidationRule|\Tune\Contracts\Validation\InvokableRule  $invokable
     * @return \Tune\Contracts\Validation\Rule
     */
     ...
     *
     * @return \Tune\Contracts\Validation\ValidationRule|\Tune\Contracts\Validation\InvokableRule
     */
