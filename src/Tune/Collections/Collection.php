...
use ArrayAccess;
use ArrayIterator;
use Tune\Contracts\Support\CanBeEscapedWhenCastToString;
use Tune\Support\Traits\EnumeratesValues;
 ...
 * @implements \Tune\Support\Enumerable<TKey, TValue>
 */
class Collection implements ArrayAccess, CanBeEscapedWhenCastToString, Enumerable
{
    /**
     * @use \Tune\Support\Traits\EnumeratesValues<TKey, TValue>
     */
     ...
     *
     * @param  \Tune\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|null  $items
     * @return void
     */
     ...
     *
     * @return \Tune\Support\LazyCollection<TKey, TValue>
     */
     ...
     *
     * @param  \Tune\Contracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$lists
     ...
     *
     * @param  \Tune\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Tune\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Tune\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string  $keys
     * @return static
     */
     ...
     *
     * \Tune\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TKey>|TKey  $keys
     *
     * @return $this
     */
     ...
     *
     * @param  \Tune\Contracts\Support\Arrayable<TKey, TMergeRecursiveValue>|iterable<TKey, TMergeRecursiveValue>  $items
     ...
     *
     * @param  \Tune\Contracts\Support\Arrayable<array-key, TCombineValue>|iterable<array-key, TCombineValue>  $values
     ...
     *
     * @param  \Tune\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string|null  $keys
     * @return static
     */
     ...
     * @return TValue
     *
     * @throws \Tune\Support\ItemNotFoundException
     * @throws \Tune\Support\MultipleItemsFoundException
     */
     ...
     * @template TZipValue
     *
     * @param  \Tune\Contracts\Support\Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue>  ...$items
     ...
     *
     * @return \Tune\Support\Collection<TKey, TValue>
     */
